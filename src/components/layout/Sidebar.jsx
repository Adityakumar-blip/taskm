  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {!collapsed && <span className="whitespace-nowrap">Purposr</span>}
          <button
        ...
        >
          ...
          >
            <Image
              src={
                "https://images.unsplash.com/photo-1526413425697-1d271fdbe7a9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODZ8fG1vZGVsfGVufDB8fDB8fHww"
              }
              height={36}
              width={36}
              alt="profile image"
            ...
            {!collapsed && (
              <div className="flex flex-col ">
                <span className="text-indigo-50 my-0">Shivam Chaudhary</span>
